    ...
    debugBar : {
        ...
        _generateTemplate : function(){
            var styles =    '<style>'+
                                ...
                                '#crafty-debug ul.menu li.version{font-weight: bold; width: 110px;}'+
